...
<div class="app-wraper">
	...
	<div class="discuss-content">
		<ul>
			<li v-for="com in allcommentlist">
				<div class="discuss-name">
					...
					<div class="nick-content">
						...
						<span class="floor floor-yz">{{com.userInfo.num_zan}}</span>
					</div>
				</div>
				<div class="discuss-text">{{com.content}}</div>
				<router-link tag="div" class="two-discuss" :to="{path:'/commentDescribe',query:{id:32,user_id:23423}}">
